...
class AdminSubCat extends Component {
    ...
    state = {
        formdata: {
            cat: {
                _id: this.props.chosenSubCatInfo._id || null,
                title: this.props.chosenSubCatInfo.title || null,
                description: this.props.chosenSubCatInfo.description || null
    ...
    onClickHandler = () => {
        ...
        if (this.state.selectedFile) {
            ...
            axios.post(`http://${config.IP_ADDRESS}:3001/upload-cat/${this.props.chosenSubCatInfo._id}`, data, { 
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td colSpan="2">
                                        <button type="button" 
                                            className="delete" 
                                            onClick={(e) => { if (window.confirm('Are you sure you wish to delete this category?')) this.removeCat(e, this.props.chosenSubCatInfo._id) } }
                                        >
                                            Delete Category
                                        </button>
